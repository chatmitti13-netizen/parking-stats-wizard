    ...
    <header className="sticky top-0 z-40 bg-card/95 backdrop-blur border-b border-border">
      <div className="flex items-center justify-between px-6 py-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground">Baxmal District Administration</p>
            <h1 className="text-xl font-semibold text-foreground">Baxmal District Statistics Platform</h1>
          </div>
        </div>
        <div className="flex items-center gap-3">
          <div className="relative hidden lg:block">
            ...
            <input
              type="search"
              placeholder="Search reports, mahallas, officers"
