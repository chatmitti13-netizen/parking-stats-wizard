        ...
        <Card className="border-border/60">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-wrap gap-3">
              <Button onClick={() => toast.success("Topshiriq tasdiqlandi")}>Tasdiqlash</Button>
              <Button variant="destructive" onClick={() => toast.error("Topshiriq rad etildi")}>Rad etish</Button>
            </div>
          </CardContent>
        </Card>
        <Card className="border-border/60">
